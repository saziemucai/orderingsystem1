...
<form id="qty" name="qty" method="post" action="paymentportal.php" onSubmit="return check()" >
...
<div id="templatemo_container">
  <br> 
    ...
    <div id="templatemo_content_left">
      ...
      echo '<div class="templatemo_meal_box"> <a rel="facebox" href=portal.php?id=' . $row3["product_id"] . '><img alt="Meal" src="images/meals/'.$row3['product_photo'].'" width="55px" height="50px" /></a>';
...
$resulta = mysql_query("SELECT * FROM orderdetails WHERE transactioncode = '$memid'");
	...
	while($row = mysql_fetch_array($resulta))
        ...
        echo '<tr>';
          ...
          echo '<td><div align="center">'.'<a href=delorder.php?id=' . $row["orderid"] . '>' . 'Cancel' . '</a>'.'</div></td>';
        echo '</tr>';
		}
        ...
        <br>
		  ...
		  $resulta = mysql_query("SELECT sum(total) FROM orderdetails");
	  ...
	  <table width="273" border="0" cellpadding="0" cellspacing="0" style="color:#000000; font-family:Arial, Helvetica, sans-serif; font-size:10px;">
	  	 ...
	  	 <div id="templatemo_content_right">
		<form method="post" action="paymentportal.php" name="abcd" onsubmit="validateForm"> </div>
