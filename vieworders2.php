...
<body>
<form action="refresh4.php" method="post">
<table id="orderdetails" width="805"height="200" border="1" cellpadding="0" cellspacing="0" style="color:#000000; font-family:Arial, Helvetica, sans-serif; font-size:15px;">
		...
		include('config.php');
		require('refresh.php');
		$cusid = $_SESSION['SESS_FIRST_NAME'];
		
		$resulta = mysql_query("SELECT * FROM orderdetails WHERE transactioncode = '$cusid'");

			while($row = mysql_fetch_array($resulta))
			{
		
        echo '<tr>';
		 echo '<td><div align="center">'.$row['orderid'].'</div></td>';
	...
	<tr>
		  ...
		  $resulta = mysql_query("SELECT sum(total) FROM orderdetails WHERE transactioncode = '$memid'");
...
<form action="refresh4.php" method="post">
<a href="vieworders2.php"><img src="images/28.png"></a>
</form>
</body>
</html>
