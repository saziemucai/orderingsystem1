...
include('config.php');
$transactioncode=$_POST['transactioncode'];
$result = mysql_query("SELECT * FROM orderdetails3");
...
include('config.php');
$transactioncode=$_POST['transactioncode'];
$result = mysql_query("SELECT sum(total) FROM orderdetails3");
while($row1 = mysql_fetch_array($result))
{
...
<form action="refresh3.php" method="post">
<a href="order.php"><img src="images/okay.jpg"></a>
</form>
